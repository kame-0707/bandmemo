      ...
      response = client.chat(
        parameters: {
          ...
          messages: [
            ...
            3. #{input_content}の内容を、箇条書きで簡潔にまとめること(例: ・内容1)。
            4. 小見出しは必ず番号付きで、番号と小見出し全体を**で囲んで太字にすること（例: **1. 小見出し**）。
            5. 小見出しの数が少なすぎないように注意すること。
            6. 各小見出しと各箇条書きの後には、必ず改行を入れること。
            7. 各小見出しと各箇条書きの後には、空行を入れない。"
          },
            { role: "user",
            content:
              "以下の内容を要約してください。
